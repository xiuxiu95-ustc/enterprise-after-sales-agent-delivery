...
class TraceService:
    ...
    def get_stage_timings(self, trace: Dict[str, Any]) -> List[Dict[str, Any]]:
        ...
        for s in stages:
            ...
            # Older trace producers emitted selected attributes at stage level.
            # Project them into data without overriding the canonical shape.
            if "method" in s and "method" not in stage_data:
                stage_data["method"] = s["method"]
            timings.append(
                {
